          ...
          this.state.isShowCreatePlayList === false ? (<View style={{width:'100%', height:0.28}} />) : (
            <View>
              <View style={{height:53, flexDirection:'row'}}>
                ...
                <Ripple onPress={this.showBottomMenu.bind(this, 'SelfPageLike')} style={{width:43, height:'100%', justifyContent:'center', alignItems:'center', borderBottomWidth:0.18, borderColor:'#888'}}>
              ...
              <View style={{height:53, flexDirection:'row'}}>
                ...
                <Ripple onPress={this.showBottomMenu.bind(this, 'SelfPageCreate')} style={{width:43, height:'100%', justifyContent:'center', alignItems:'center', borderBottomWidth:0.18, borderColor:'#888'}}>
                  <SuperIcon type={'\ue653'} style={{fontSize:23, color:'#BBB'}} />
                </Ripple>
              </View>
            </View>
