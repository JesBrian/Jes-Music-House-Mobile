...
class MusicPlayer extends React.Component {
  ...
  render () {
    ...
    return (
      <View style={{width:Dimensions.get('window').width, height:65, top:Dimensions.get('window').height - (Platform.OS === 'ios' ? 65 : 85), left:0, paddingTop:12, position:'absolute', zIndex:5}}>
